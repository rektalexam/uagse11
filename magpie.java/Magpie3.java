...
public class Magpie3
{
	...
	public String getResponse(String statement)
	{
		...
		{
			response = "WHAT A BITCH";
		}
		else if (findKeyword(statement, "muslim") >= 0)
		{
			response = "INFIDEL";
		}
		else if (findKeyword(statement, "life") >= 0)
		{
			response = "We dont speek of meaningless things";
		}
	...
	private String getRandomResponse()
	{
		...
		{
			response = "Sorry was not listening bc i do not care";
		}
